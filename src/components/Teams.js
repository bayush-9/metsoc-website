...
const Teams = () => {
	...
	return (
		<>
			<Navbar />
			<section className="py-0 md:py-0 btn w-[90vw] h-[85vh] m-auto rounded-xl text-white">
						...
						<article className="flex flex-col rounded-xl">
							<div className="flex flex-col flex-1 p-0 text-center">
								<p className="m-auto text-[50px] sm:text-[75px] font-bold">
									Meet
									<br />
									<p className="m-auto text-[65px] sm:text-[85px] font-bold">Our Team</p>
								</p>
							</div>
						</article>
						<article className="flex flex-col rounded-xl">
							<div className="flex flex-col flex-1 p-0 text-center ">
								<p className="m-auto text-[50px] sm:text-[75px] font-bold">
									<img src={teams} className="m-auto w-[85vh] h-auto " alt="robot" />
								</p>
							</div>
						</article>
					</div>
